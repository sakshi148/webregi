...
function checkValidation(){
     ...
     if(document.getElementById("customCheck1").checked==false && document.getElementById("customCheck2").checked==false && document.getElementById("customCheck3").checked==false)
     {
      ...
      if(document.getElementById("customCheck1").checked==true){technologies_known.push("A positive");}    
      if(document.getElementById("customCheck2").checked==true){technologies_known.push("B positive");}
      if(document.getElementById("customCheck3").checked==true){technologies_known.push("O positive");}
